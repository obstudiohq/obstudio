...
<Subtitle>A guide to using TypeScript with Obstudio.</Subtitle>
<Meta name="description" content="A guide to using TypeScript with Obstudio." />

## Namespaces

Obstudio uses namespaces to organize types. Every component has two core interfaces:
...
When creating wrapping components, you can use the `Props` type to accept all of the underlying Obstudio props for the component.
...
Types relating to custom Obstudio events are also exported on component parts' namespaces.
