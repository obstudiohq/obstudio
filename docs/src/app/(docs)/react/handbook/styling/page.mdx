...
<Subtitle>A guide to styling Obstudio components with your preferred styling engine.</Subtitle>
<Meta
  name="description"
  content="Learn how to style Obstudio components with your preferred styling engine."
/>

Obstudio components are unstyled, don't bundle CSS, and are compatible with Tailwind, CSS Modules, CSS-in-JS, or any other styling solution you prefer.
