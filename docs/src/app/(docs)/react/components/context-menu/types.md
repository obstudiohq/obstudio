...
[//]: types.ts '<-- Autogenerated By (do not edit the following markdown directly), run: pnpm docs:validate "(docs)/react/components/context-menu"'
...
- `ContextMenu.Positioner`: `ContextMenu.Positioner`, `ContextMenu.Positioner.Props`, `ContextMenu.Positioner.State`
